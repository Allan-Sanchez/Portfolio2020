            ...
            <form name="contact-form" method="POST"  data-netlify="true">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg" placeholder="Allan Sanchez">
                    </div>
                    <div class="col-md-6">
                        <h4 class="title-form">{{ $t('Contact.form2') }}</h4>
                        <input type="email" name="email" class="form-control form-control-lg" placeholder="emial@example.com">
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        ...
                        <textarea name="message" class="form-control form-control-lg" id="exampleFormControlTextarea1" placeholder="Enter your message here" rows="6"></textarea>
                    </div>
